...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12" style=" ">
            <form action="/WorkManageSystem/teacher/t_publishWork" method="post">
                <div class="text" style="float: left;margin-left: 10%;">
                    ...
                    <div class="input-group input-group-sm" style="width: 250px;">
                        ...
                        <input type="date" class="form-control"  name="w_deadline">
                    </div><br><br>
                    <div class="input-group input-group-sm" style="width: 250px;">
                        ...
                        <select class="form-control" name = "w_course">
                           <c:if test="${! empty course }">
                				<c:forEach items="${course }" var="cur"> 
	                        	   <option>${cur.c_name }</option><%-- <input type = "hidden" value = "${cur.c_id }"/> --%>
	                            </c:forEach>
                            </c:if>
                        </select>
                    </div><br><br>
                    <div class="input-group input-group-sm" style="width: 250px;">
                        ...
                        <select class="form-control" name = "w_c_id">
