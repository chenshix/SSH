...
<body>
	...
	%> --%>
	<div class="container-fluid" style="background-color: blasck; margin-left:100px;margin-right:100px; padding-top: 0px;">
		<div class="row-fluid">
			<div class="span12">
			<!-- 顶部 -->
			...
			<hr />
			<address> <strong>Nchu, Inc.</strong>&nbsp; 795 Folsom Ave, Suite 600&nbsp; San Francisco, CA 94107&nbsp;<abbr title="Phone">P:</abbr> (123) 456-7890</address>
			</div>
